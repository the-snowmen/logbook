---
name: handoff
description: Write the "start here next session" brief in the logbook journal — state coming in, the goal, design references, open questions, working rules, and a verified starting state. The newest handoff is what /logbook:resume reads first. Invoke with /logbook:handoff.
